...
**Visual is not a decentralized Programming**

Statement of Interests: *update* 
...
The form and function as a fundamental truth that we have held behind Time composition anti-movement of time is a change in don't mention. 
...
There are wood, the metal kind of wooden shape, without having to design materialism and the exojointary of the combination of wood structure

Those movement between joinery and the mechanical rotation of the reenforcement of the structural bases of digital programming activities. A rotation of scale and surface texturalisation of the materials are consistently a paradigm in programming construct and model space activities at the stage of installations and freestanding movement of an actual likeness of kinetic robotic system. Although it should still be regarded as sculptures

Therefore extrusion should intent to form follow function if any within the form itself.


blob:https://x.com/829cd53f-1c95-4ac2-baad-db1e34108ae5<img width="1191" height="842" alt="image" src="https://github.com/user-attachments/assets/14f265cf-b8ba-44bf-94b1-8f5f8a241981" />
